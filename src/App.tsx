...
function App() {
  ...
  return (
    <div className="w-full h-screen bg-gray-400 flex items-center justify-center [perspective:800px]">
      <div
        ...
        <div className='px-4 py-8 bg-white border border-gray-100 rounded-2xl'>
          <div className="h-[160px] w-full bg-gray-900 rounded-xl mb-14">
            <div className="w-[120px] h-[120px] bg-gray-900 border-4 border-white absolute rounded-full mb-4 top-[120px] left-[40px]"></div>
          </div>
          ...
          <p className='text-sm text-gray-500'>With 9+ years of experience, I've overseen 7+ successful mid-to-large scale projects. Leading diverse teams, including developers, QA, and UI/UX designers to deliver projects spanning across diverse domains from web to IoT solutions.</p>
